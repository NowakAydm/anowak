...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   get_next_line_charbychar.c                         :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: anowak <anowak@student.42.fr>              +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2015/10/29 14:32:19 by anowak            #+#    #+#             */
/*   Updated: 2015/10/29 15:02:44 by anowak           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int		read_next_line(int fd, t_list *cur, char **line, char *f(char*))
{
	char	*buf;
	char	*new;
	int		ret;
...
int		get_next_line_charbychar(int const fd, char **line, char *f (char*))
{
	...
	{
		ret = read_next_line(fd, list, line, f);
		if (ret == -1)
		{
